# Generated by Django 3.0.1 on 2020-04-03 23:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, help_text='出生日期', null=True, verbose_name='出生年月')),
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女')], default='male', help_text='性别(male/female)', max_length=6, verbose_name='性别')),
